...
router.get('/', authMiddleware, transcricaoController.getAllTranscricaos);
router.get('/audio/:audioId', authMiddleware, transcricaoController.getTranscricaoByAudioId);
router.get('/:id', authMiddleware, transcricaoController.getTranscricaoById);
